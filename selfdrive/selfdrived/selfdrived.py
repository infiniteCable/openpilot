...
class SelfdriveD:
  ...
  def update_events(self, CS):
    ...
    if not REPLAY:
      ...
      cruise_mismatch = CS.cruiseState.enabled and (not self.enabled or not self.CP.pcmCruise) and not (self.sm['controlsState'].lateralOnly and CS.cruiseState.available)
