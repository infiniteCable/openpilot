...
class CarControllerParams:
  ...
  def __init__(self, CP):
    ...
    if CP.flags & VolkswagenFlags.PQ:
      ...
      self.ANGLE_ERROR                     = 2    # HCA_03 maximum difference from steering angle
      self.ANGLE_REQ_DIFF                  = 40   # OP angle request offset from current angle for steering power setting
